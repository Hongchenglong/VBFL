...
"""
python server.py -nc 20 -mn mnist_cnn -iid 0 -ncomm 100 -nm 3
python server.py -nc 20 -mn mnist_bcnn -iid 0 -ncomm 100 -nm 3 
"""
...
if __name__=="__main__":
	...
	log_files_folder_path = f"./logs/{date_time}_{args['model_name']}"
